...
class IssueRelationsControllerTest extends TestCase
{
    ...
    public function testIndexReturnsOnlyRelationsFromAuthorizedProjects(): void
    {
        $this->mockService(
