...
/**
 * Issue relations table policy.
 */
class IssueRelationsTablePolicy
{
    /**
    ...
    /**
     * Any authenticated user may list issue relations from accessible projects.
     *
    ...
    /**
     * Any authenticated user may attempt to add an issue relation. The entity
     * policy enforces issue-project membership when the target issue is known.
     *
     * @param \Authorization\IdentityInterface $user The user.
     * @return bool
     */
